...
Q_DECLARE_INTERFACE(JApp::Models::SorterContainer, SorterContainer_iid)

QML_DECLARE_TYPEINFO(JApp::Models::SorterContainerAttached, QML_HAS_ATTACHED_PROPERTIES)
